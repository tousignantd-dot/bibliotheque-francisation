...
# Le manifeste de CE module. La coquille d'origine pointait sur
# `sons_module_n7_recherche.json`, celui de l'activité 110 : le fichier
# existant, rien ne levait d'erreur, et le générateur aurait produit les
# 221 extraits du niveau 7 au lieu des 334 du sien — 9 clés en commun,
# et un module troué dont personne n'aurait su pourquoi. Repérée le
# 23 août 2026 par trois agents indépendamment, avant toute production.
