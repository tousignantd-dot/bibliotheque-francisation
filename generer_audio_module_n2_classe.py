#!/usr/bin/env python3
"""
Générateur d'audio — module « Ouvrez votre cahier » (niveau 2) (module-n2-classe).
...
`build/contenu/module-n2-classe/dialogues.js`, la source unique.
...
`build/collecte_sons.py`, qui écrit `sons_module_n2_classe.json`.

Usage :  python3 generer_audio_module_n2_classe.py [--force] [--only prefixe,...]
"""
import json
import os
import re
...
SORTIE = RACINE / "assets/interactive/module-n2-classe"
MANIFESTE = RACINE / "sons_module_n2_classe.json"
DIALOGUES_JS = RACINE / "build/contenu/module-n2-classe/dialogues.js"
...
# même dialogue, ils ne peuvent pas partager une voix.
VOIX_PERSO = {
    "TARIQ":     "masculin_1",
    "MYRIAM":    "feminin_2",
...
def main():
    ...
    print(f"🔊 module-n2-classe — {len(taches)} extraits "
