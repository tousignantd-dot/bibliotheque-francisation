...
SORTIE = RACINE / "assets/interactive/module-n8-habitation"
MANIFESTE = RACINE / "sons_module_n8_habitation.json"
DIALOGUES_JS = RACINE / "build/contenu/module-n8-habitation/dialogues.js"
...
def main():
    ...
    if not MANIFESTE.exists():
        print(f"❌ {MANIFESTE.name} introuvable — "
              f"lancer build/collecte_sons.py module-n8-habitation")
        sys.exit(1)
    ...
    print(f"🔊 module-n8-habitation — {len(taches)} extraits "
