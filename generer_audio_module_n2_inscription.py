#!/usr/bin/env python3
"""
Générateur d'audio — module « Je m'inscris au cours de français » (niveau 2) (module-n2-inscription).
...
`build/contenu/module-n2-inscription/dialogues.js`, la source unique.
...
`node build/releve_sons.js module-n2-inscription > sons_module_n2_inscription.json`.
...
Usage :  python3 generer_audio_module_n2_inscription.py [--force] [--only prefixe,...]
"""
import json
import os
import re
...
SORTIE = RACINE / "assets/interactive/module-n2-inscription"
MANIFESTE = RACINE / "sons_module_n2_inscription.json"
DIALOGUES_JS = RACINE / "build/contenu/module-n2-inscription/dialogues.js"
...
# Quatre personnages pour quatre voix. Madame Bourgeois prend celle de
# l'enseignante, la seule que `voix_lente` ralentit à 0,85 : c'est elle qui
# demande les cases du formulaire une à une, et une case mal entendue fait
# écrire la mauvaise réponse. Marco et Hamid gardent deux voix masculines
# distinctes — le voisin qui montre l'annonce et l'élève qui, à la fin, se
# fait expliquer la case « scolarité » ne doivent pas se confondre.
VOIX_PERSO = {
    "YARA":           "feminin_2",
    "MARCO":          "masculin_1",
    "MME BOURGEOIS":  "enseignante",
    "HAMID":          "narrateur",
}
...
def main():
    ...
    print(f"🔊 module-n2-inscription — {len(taches)} extraits "
