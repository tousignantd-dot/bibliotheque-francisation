...
| `validation` | `~/Claude/wt-validation` | `viewer.html`, `build/greffe_ateliers.py`, `assets/design-system/ateliers-mobile.css`, les 27 ateliers d'avant le système de design | fusionné dans `main` — le worktree reste, la suite y est attendue |
