...
| `maison-francoeur` | dépôt principal | `build/contenu/entreprise-francoeur/`, `build/francoeur_*.py`, `assets/interactive/francoeur/`, `assets/presentations/francoeur-*.html`, `presentations.html` (une fiche) | **en cours — 24 septembre 2026.** Étapes 0, 1 et 2 poussées (lexique, 105 croquis, 169 voix, 11 langues, planches et cinq exercices). Point d’arrêt : essai avec un vrai employé avant l’étape 3. |
