...
| `maison-francoeur` | dépôt principal | `build/contenu/entreprise-francoeur/`, `build/francoeur_*.py`, `assets/interactive/francoeur/`, `assets/presentations/francoeur-*.html`, `presentations.html` (une fiche) | **en cours — 24 septembre 2026.** Étape 0 du plan magasin de vêtements : lexique, trois croquis d'essai, page de validation. |
