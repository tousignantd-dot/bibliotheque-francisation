...
| `maison-francoeur` | dépôt principal | `build/contenu/entreprise-francoeur/`, `build/francoeur_*.py`, `assets/interactive/francoeur/`, `assets/presentations/francoeur-*.html`, `presentations.html` (une fiche) | **en cours — 24 septembre 2026.** Étapes 0 à 3 poussées (lexique, 105 croquis, 197 voix, 11 langues, planches, cinq exercices, test de niveau). Suite : étape 4, le magasin. |
