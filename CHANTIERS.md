...
| `maison-francoeur` | dépôt principal | `build/contenu/entreprise-francoeur/`, `build/francoeur_*.py`, `assets/interactive/francoeur/`, `assets/presentations/francoeur-*.html`, `presentations.html` (une fiche) | **en cours — 24 septembre 2026.** Étapes 0 et 1 du plan magasin de vêtements poussées (lexique, 105 croquis, 149 voix, 11 langues, écran des planches). Suite : étape 2, les exercices. |
