...
<title>Ce que le programme prescrit, module par module — SAAF</title>
...
<style>
  /* Page générée par build/tableau_programme.py — ne pas retoucher à la main.
     Système de design Francisation / SAAF, thème clair unique. Le violet
...
<header class="bande">
  <div class="conteneur">
    ...
    <div class="saaf-lockup saaf-lockup--grand">
      <span class="saaf-pilule"><span class="saaf-nom">SAAF</span></span>
      <span class="saaf-filet" aria-hidden="true"></span>
      <span class="saaf-desc">Système d'aide<br>à l'apprentissage<br>du français</span>
    </div>
