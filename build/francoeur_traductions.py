...
INTERFACE = {
    ...
    "apprendre_sous": "Les onze rayons, mot par mot.",
    "exercer": "Je m'exerce",
    "exercer_sous": "Cinq exercices, du mot au client.",
    "exercices": "Les exercices",
    "tous_rayons": "Tous les rayons",
    "ex_ecoute": "Je l'entends, je le trouve",
    "ex_ecoute_c": "Écoutez, puis touchez le bon vêtement.",
    ...
    "ex_rayon": "Range le rayon",
    "ex_rayon_c": "Dans quel rayon va cet article ?",
    "ex_client": "Ce que le client veut",
    "ex_client_c": "Écoutez le client. Touchez ce qu'il demande.",
    "reecouter": "Réécouter",
    ...
    "ca_cest": "Ça, c'est :",
    "bon_article": "Bon article",
    "mauvais_article": "Pas le bon article",
    "bonne_couleur": "bonne couleur",
    "mauvaise_couleur": "pas la bonne couleur",
    "bonne_taille": "bonne taille",
    "mauvaise_taille": "pas la bonne taille",
