const DIALOGUES = {
  ...
  prep: {
    ...
    lines: [
      ...
      ["HUGUETTE","Quatre cents dollars en douze paiements. Le reste est parti en frais de crédit. Ton taux est écrit là, dans le petit encadré : dix-neuf et quatre-vingt-dix."],
