  ...
  prGraphie: {
    ...
    blocs:[
      ...
      {t:'ana', h:"X qui se dit S — les nombres, presque uniquement",
       ...
       mots:[['On lit','si{x} · di{x} · soi{x}ante-quinze'],
             ['On entend','[s] — « siss », « diss », « soi-sante-quinze »', true],
             ['Ce qui suit décide','seul : on entend le s · devant une consonne : il se tait · devant une voyelle : il se lie']],
       say:"six, soixante-quinze, six mois, dix jours",
      ...
      {t:'labo', h:'Écoutez, puis répétez',
       ...
       out:{
         ...
         s1:{w:["six"], say:"six", n:'« siss » : le nombre est seul, le x se dit s'},
      ...
      {t:'check', h:'Quatre questions, une minute',
       ...
       qs:[
         ...
         {q:"Le x de « dix-huit » sonne…", opts:["comme un z","comme un s"], ok:0,
          fb:"« Di-zuit » : devant une voyelle, le x se lie et se dit z."},
      ...
      {t:'revoir', h:'À retenir',
       p:"Trois cas, et rien d'autre : <b>ch</b> qui dit k dans les mots d'étude (chorale, technologie, psychologue, chaos), <b>x</b> qui dit s dans les nombres (six, dix, soixante-quinze), <b>sh</b> et <b>sch</b> qui disent ch dans les emprunts (schéma, sushi, flash, t-shirt)."},
    ]
  },
