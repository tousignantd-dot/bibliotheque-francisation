  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-sub">Les neuf choses à faire avant de quitter le comptoir</div>
     <div class="jr-sujets">
     ...
     <div class="jr-gram">
       ...
       Glissez vos questions dans une phrase :
       <span class='savoir-ex'>Je voudrais savoir <b>si</b> je garde ma place. · Pourriez-vous me dire <b>quand</b> je dois remettre le formulaire. · Je ne sais pas <b>ce qu'</b>il faut écrire dans la case du motif.</span>
       Placez vos dates avec le bon petit mot :
       <span class='savoir-ex'>Je serai absente <b>à partir du</b> 9 mars, <b>jusqu'au</b> 27 <b>inclusivement</b>. · Le formulaire doit être remis <b>d'ici le</b> 6.</span>
       Promettez au futur simple :
       <span class='savoir-ex'>Je <b>reviendrai</b> le 30 mars. Je vous <b>apporterai</b> la pièce justificative. Je <b>m'inscrirai</b> au rattrapage.</span>
       Expliquez sans vous plaindre, avec le subjonctif :
       <span class='savoir-ex'><b>Il faut que</b> je travaille le matin. · <b>Pour que</b> le transfert <b>se fasse</b>, que dois-je remplir ?</span>
       Mettez devant ce qui compte, une seule fois :
       <span class='savoir-ex'><b>Ce qui me bloque, c'est</b> l'horaire, pas le cours. · <b>Ce que je demande, c'est</b> un transfert au groupe du soir.</span>
       Enchaînez vos raisons :
       <span class='savoir-ex'><b>Comme</b> j'ai commencé un emploi, mon horaire a changé ; <b>c'est pourquoi</b> je vous demande un changement de groupe. <b>Par contre</b>, je ne pourrai pas commencer avant le 20.</span>
     </div>

     <div class="jr-sep"></div>
     <div class="jr-sub">Choisissez votre affaire et qui vous avez en face</div>
     <div class="jr-choix">
       <div class="jr-choix-l">Quelle affaire ?</div>
       ...
       <button class="btn btn-pri" id="jrStart" type="button" onclick="jrDemarrer()" style="margin-top:14px">Me présenter au comptoir</button>
     </div>
