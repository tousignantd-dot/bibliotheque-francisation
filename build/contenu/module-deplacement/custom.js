  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     <div class="c-hdr"><span class="tag" style="background:#0F766E">Jeu de rôle</span><span class="ctit" style="color:#0F766E">Demande ton chemin, ou explique-le</span></div>
  ...
  document.getElementById('exs-retiens').innerHTML = `
   <div class="card custom">
     ...
     <div style="font-weight:800;color:#166534;font-size:13px;margin:6px 0 4px">Dans la rue</div>
     <textarea rows="2" placeholder="Ex. : un coin de rue, un feu de circulation, un trottoir, traverser, en face de…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Dans le transport</div>
     <textarea rows="2" placeholder="Ex. : un terminus, un quai, une correspondance, la direction, un titre de transport…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Pour donner une direction</div>
     <textarea rows="2" placeholder="Ex. : continuez tout droit, tournez à gauche, jusqu'au feu, par le corridor, au bout de…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Sur un horaire ou un plan</div>
