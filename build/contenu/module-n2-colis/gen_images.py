...
def main():
    ...
    for nom, dossier, page, prompt in IMAGES:
        ...
        # moins : les deux se réduisent, seulement pas au même format. Six
        # images brutes, c'est quatre mégaoctets à charger pour un élève qui
        # ouvre le module sur le forfait de données de son téléphone.
        try:
            data = reduire(data, *((800, 82) if dossier == 'vocab'
                                   else (1200, 85)))
        except Exception as e:
