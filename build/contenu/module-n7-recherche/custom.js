   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Demandez poliment</div><div class="jr-rappel-x"><b>Pourriez-vous</b> me préciser à quelle date l'entrée en fonction est prévue ?</div></div>
         <div><div class="jr-rappel-l">Dites votre but</div><div class="jr-rappel-x">Je vous appelle <b>pour que vous ayez</b> mon nom en tête avant de recevoir mon dossier.</div></div>
         <div><div class="jr-rappel-l">Mettez en avant ce qui compte</div><div class="jr-rappel-x"><b>Ce que j'apporte, c'est</b> neuf ans de contrôle de conformité.</div></div>
         <div><div class="jr-rappel-l">Restreignez</div><div class="jr-rappel-x">Je <b>n'</b>ai travaillé <b>qu'</b>en laboratoire industriel.</div></div>
         <div><div class="jr-rappel-l">Changez de sujet proprement</div><div class="jr-rappel-x"><b>Quant à</b> l'installation dans la région, j'aurais une question.</div></div>
       </div>
     </div>
