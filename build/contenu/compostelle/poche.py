...
URGENCES = [
    ...
    ("perdido", "Me he perdido. ¿Dónde está el Camino?", "Je me suis {perdu|perdue}. Où est le chemin ?"),
    ...
    ("caido", "Me he caído y me duele mucho el tobillo.", "Je suis {tombé|tombée} et j'ai très mal à la cheville."),
...
FORMES_ALG = {
    ...
    "frutos_secos": {"pedir": "Vale, gracias. Entonces, con tomate y aceite.", "pedirfr": "D'accord, merci. Alors, avec tomate et huile.", "platob": "la sopa de almendras", "caldofr": "une soupe aux amandes (des fruits à coque)", "frde": "des noix", "frneg": "de noix", "court": "noix", "ens": "nueces",
    ...
    "cacahuetes": {"pedir": "Vale, gracias. Entonces, con tomate y aceite.", "pedirfr": "D'accord, merci. Alors, avec tomate et huile.", "platob": "el caldo con cacahuete", "caldofr": "un bouillon à la sauce d'arachide", "frde": "des arachides", "frneg": "d'arachides", "court": "arachides", "ens": "cacahuetes",
    ...
    "marisco": {"pedir": "Vale, gracias. Entonces, con tomate y aceite.", "pedirfr": "D'accord, merci. Alors, avec tomate et huile.", "platob": "el caldo de marisco", "caldofr": "un bouillon de fruits de mer", "frde": "des fruits de mer", "frneg": "de fruits de mer", "court": "fruits de mer", "ens": "gambas, que son marisco",
    ...
    "pescado": {"pedir": "Vale, gracias. Entonces, con tomate y aceite.", "pedirfr": "D'accord, merci. Alors, avec tomate et huile.", "platob": "el caldo de pescado", "caldofr": "un bouillon de poisson", "frde": "du poisson", "frneg": "de poisson", "court": "poisson", "ens": "atún, que es pescado",
    ...
    "huevo": {"pedir": "Vale, gracias. Entonces, con tomate y aceite.", "pedirfr": "D'accord, merci. Alors, avec tomate et huile.", "platob": "el caldo con huevo", "caldofr": "un bouillon à l'œuf", "frde": "des œufs", "frneg": "d'œufs", "court": "œufs", "ens": "huevo duro",
    ...
    "leche": {"pedir": "Entonces, sin mantequilla: con tomate y aceite.", "pedirfr": "Alors, sans beurre : avec tomate et huile.", "platob": "la crema de verduras", "caldofr": "une crème de légumes, à la crème (du lait)", "frde": "du lait", "frneg": "de lait", "court": "lait", "ens": "queso, que es de leche",
    ...
    "gluten": {"pedir": "Entonces, con pan sin gluten, por favor.", "pedirfr": "Alors, avec du pain sans gluten, s'il vous plaît.", "platob": "el caldo con fideos", "caldofr": "un bouillon aux nouilles (du gluten)", "frde": "du gluten", "frneg": "de gluten", "court": "gluten", "ens": "picatostes, que llevan gluten",
    ...
    "sesamo": {"pedir": "Entonces, con pan normal, sin semillas.", "pedirfr": "Alors, avec du pain ordinaire, sans graines.", "platob": "el caldo con sésamo", "caldofr": "un bouillon au sésame", "frde": "du sésame", "frneg": "de sésame", "court": "sésame", "ens": "semillas de sésamo",
