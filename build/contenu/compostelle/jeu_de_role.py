...
BILAN = (
    ...
    "« phrases » : jusqu'à trois phrases du pèlerin qui sont FAUTIVES ou peu naturelles en espagnol "
    "d'Espagne — jamais une phrase correcte (« soy alérgica » est juste : on ne la remplace pas par une "
    "autre formule juste), jamais pour un accent ou une virgule : « dit » (sa phrase) et « mieux » (la "
    "même idée, correcte et naturelle). Liste vide si tout était juste.\n"
