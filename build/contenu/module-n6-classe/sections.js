const SECTIONS = [
  ...
  {id:'prep', no:'<img class="icon-svg tno-play" src="/assets/interactive/module-n6-classe/icons/play.svg" alt="">', title:'Je découvre', color:'#A5335F',
   ...
   intro:"Milagros Zevallos a quarante-trois ans. Elle est arrivée du Pérou il y a cinq ans, où elle était technicienne de laboratoire, et elle suit sa francisation le jour au Centre d'éducation des adultes des Trois-Chênes, à Sainte-Angèle-des-Prés. Un lundi matin, son enseignante annonce un travail de recherche en équipe : trois semaines, un sujet à choisir, trois sources au minimum, un texte à remettre et cinq minutes devant la classe. Milagros prend le bac brun de son balcon — deux ans qu'elle ne sait pas ce qui a le droit d'aller dedans.",
