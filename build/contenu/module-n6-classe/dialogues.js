const DIALOGUES = {
  ...
  // l'équipe de Milagros — sous trois angles : l'annonce en classe, la
  ...
  prep: {
    ...
    lines: [
      ...
      ["MILAGROS","Trois semaines de quoi, madame ?"],
      ...
      ["MILAGROS","Et le sujet, on le choisit vraiment ? Ou bien il est déjà choisi et vous nous laissez croire qu'on choisit ?"],
      ...
      ["MILAGROS","Moi, je prendrais le bac brun. Ça fait deux ans que j'en ai un sur mon balcon et je ne sais toujours pas ce qui a le droit d'aller dedans."],
      ...
      ["YOUSSEF","Je veux bien me mettre avec Milagros. Mais on cherche où, l'information ? Sur Internet, il y a tout et le contraire de tout."],
      ...
      ["MILAGROS","Trois sources différentes… Une page de la ville, un article de journal, ça compte ?"],
      ...
      ["MILAGROS","Ça me semble beaucoup pour trois semaines."],
  ...
  t1: {
    ...
    lines: [
      ["MILAGROS","Madame, on a lu la feuille tous les deux et on n'est pas d'accord sur ce qu'il faut remettre."],
      ...
      ["YOUSSEF","Sur le nombre de textes. Moi je comprends qu'on remet un seul document. Milagros pense qu'il y en a deux."],
      ["MIREILLE","Relisez-moi la deuxième ligne du paragraphe deux, celle qui commence par « chaque équipe remettra »."],
      ["MILAGROS","« Chaque équipe remettra un texte de deux pages et le plan qui a servi à l'écrire. »"],
      ...
      ["MILAGROS","Il y a aussi une chose que je ne comprends pas. C'est écrit « vous choisirez votre sujet avant le 3 novembre ». Ce n'est pas une question de ce qui va arriver, ça. C'est un ordre."],
      ...
      ["MILAGROS","Donc on ne peut pas chercher les sources tout de suite."],
      ...
      ["MILAGROS","Quatre points sur combien ?"],
  ...
  t2: {
    ...
    lines: [
      ...
      ["MILAGROS","Trois documents. Mais plus on les lit, moins on comprend."],
      ...
      ["MILAGROS","Le deuxième, c'est un article du bulletin municipal du printemps passé. Il raconte l'histoire de la collecte depuis le début. C'est écrit d'une drôle de façon : « le conseil adopta le règlement », « les premiers bacs arrivèrent en avril »."],
      ...
      ["MILAGROS","J'ai buté sur une phrase. « La ville avait distribué les bacs en avril, mais la collecte ne commença qu'en juin. »"],
      ...
      ["MILAGROS","Mais alors, laquelle des trois a raison ?"],
      ...
      ["MILAGROS","Une dernière chose. Est-ce qu'on peut recopier une phrase telle quelle ?"],
