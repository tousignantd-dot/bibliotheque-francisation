  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-gram">
       ...
       Décrivez avec les trois coordonnées :
       <span class='savoir-ex'>Un <b>cognement</b>, <b>à froid</b>, <b>systématiquement</b> au passage des rapports.</span>
       Rangez les deux passés dans l'ordre :
       <span class='savoir-ex'>Quand j'ai vu la flaque, le bruit <b>avait</b> déjà <b>commencé</b>.</span>
       Mettez en avant ce qui compte :
       <span class='savoir-ex'><b>Ce que</b> je demande, <b>c'est</b> la réparation. · <b>C'est</b> la garantie légale <b>qui</b> s'applique.</span>
       Demandez au conditionnel :
       <span class='savoir-ex'><b>Accepteriez-vous</b> de faire réparer sans frais ? · Me <b>passeriez</b>-vous une autre voiture en attendant ?</span>
       Annoncez la suite au futur, jamais en menace :
       <span class='savoir-ex'>Sans réponse d'ici vendredi, je vous <b>écrirai</b>.</span>
     </div>
