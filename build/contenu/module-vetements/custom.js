  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     <div class="c-hdr"><span class="tag" style="background:#0F766E">Jeu de rôle</span><span class="ctit" style="color:#0F766E">Achète un vêtement</span></div>
     ...
     <div class="jr-gram">
       ...
       Dis ce qui ne va pas, avec un endroit :
       <span class='savoir-ex'>Il est un peu <b>serré</b> <b>aux épaules</b>.</span>
       Décris le vêtement :
       <span class='savoir-ex'>Un manteau <b>noir</b>, <b>en</b> duvet, aux genoux.</span>
       Demande un avis :
       <span class='savoir-ex'><b>Qu'est-ce que vous en pensez ?</b></span>
       Informe-toi avant de payer :
       <span class='savoir-ex'>Ça <b>s'échange</b> combien de temps ?</span>
     </div>
  ...
  document.getElementById('exs-retiens').innerHTML = `
   <div class="card custom">
     ...
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">En essayant</div>
     <textarea rows="2" placeholder="Ex. : serré aux épaules, trop large, les manches sont longues, aux genoux…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Décrire et donner un avis</div>
     <textarea rows="2" placeholder="Ex. : noir, en duvet, une coupe ample, ça te va bien, franchement…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Entretien et échange</div>
