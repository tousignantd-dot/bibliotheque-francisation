const PLUS = {
  ...
  prInto: {
    ...
    blocs:[
      {t:'texte', h:"Une mélodie, et plus aucun son à opposer",
      ...
      {t:'ana', h:"La surprise — la voix monte d'un coup, à la fin",
       ...
       mots:[['On dit','Quatre voix contre trois, pour onze hectares ?'],['La mélodie','ligne égale, puis un saut net sur la fin',true],['Le repère','on répète le chiffre qui surprend']],
      ...
      {t:'ana', h:"La déception — la voix tombe dès le début",
       ...
       mots:[['On dit',"Ah. Je pensais que l'évaluation était publique."],['La mélodie','elle part déjà en bas et continue de baisser',true],['Le repère','une petite interjection lâchée avant la phrase']],
       say:"Ah. Je pensais que l'évaluation était publique.",
       note:"Chez l'autre, c'est ce qui vous apprend qu'une réponse est tombée à plat. Personne ne vous le dira ; la mélodie vient de le faire."},

      {t:'ana', h:"La volonté — la ligne baisse et le débit se pose",
       ...
       note:"Le bouton fait entendre la phrase <b>deux fois</b> : ordinaire, puis avec l'accent. Écoutez ce qui change — c'est la comparaison qui rend l'accent audible, jamais l'accent tout seul. Une phrase de volonté dite en montant devient une demande de permission — exactement l'inverse de ce qu'on voulait."},
      ...
      {t:'ana', h:"L'incompréhension — la voix freine au milieu",
       ...
       note:"Ce freinage-là veut dire « il ne me manque qu'un mot ». Dit d'un trait, le même énoncé s'entend comme un aveu de n'avoir rien suivi."},

      {t:'labo', h:"Quatre intentions, deux exemples chacune",
       ...
       out:{
         ...
         a2:{w:["Comment ça, personne n'a répondu ?"], say:"Comment ça, personne n'a répondu ?", n:"« comment ça » prévient que l'étonnement arrive"},
         b1:{w:["Ah. Bon."], say:"Ah. Bon.", n:"deux syllabes qui tombent, et la phrase devient inutile"},
         b2:{w:["On avait trois cents signatures ce matin aussi."], say:"On avait trois cents signatures ce matin aussi.", n:"aucune remontée nulle part, du premier mot au dernier"},
