  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-sub">Les neuf choses à faire avant de raccrocher</div>
     <div class="jr-sujets">
     ...
     <div class="jr-gram">
       ...
       Nommez la case, pas votre embarras :
       <span class='savoir-ex'>Je vous appelle pour signaler <b>une absence</b>. · J'aurai <b>un retard</b> d'une heure. · Je vous écris pour <b>abandonner</b> le cours du soir.</span>
       Donnez la raison avec le bon outil :
       <span class='savoir-ex'>Je serai absente <b>parce que</b> mon fils est malade. · J'arriverai plus tard <b>à cause de</b> l'autobus. · <b>Grâce à</b> votre message, je l'ai su à temps.</span>
       Promettez au futur simple :
       <span class='savoir-ex'>Je <b>serai</b> en classe demain. Je vous <b>remettrai</b> le papier jeudi. Je <b>rattraperai</b> la matière au local 214.</span>
       Dites l'obligation comme il faut :
       <span class='savoir-ex'>Je <b>dois</b> vous remettre une note. · <b>Il faut</b> téléphoner avant huit heures. · <b>Il faudrait</b> que je passe au comptoir.</span>
       Remplacez le nom par le pronom :
       <span class='savoir-ex'>Je <b>lui</b> remettrai la note jeudi. · Je vais <b>lui</b> demander. · Rappelez-<b>moi</b> avant midi.</span>
       Rangez les choses dans le temps :
       <span class='savoir-ex'><b>D'abord</b>, je me nomme. <b>Ensuite</b>, je dis quel jour. <b>Enfin</b>, je laisse mon numéro. · <b>Avant de</b> raccrocher, je redis ce que j'ai compris.</span>
     </div>

     <div class="jr-sep"></div>
     <div class="jr-sub">Choisissez votre appel</div>
     <div class="jr-choix">
       ...
       <button class="btn btn-pri" id="jrStart" type="button" onclick="jrDemarrer()" style="margin-top:14px">Composer le 450 555-0180</button>
     </div>
