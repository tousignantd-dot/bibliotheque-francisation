...
IMAGES = [
 ...
 ('etiquette-dos', 'images', P_EX, "Photographie réaliste, format paysage, "
  "lumière naturelle douce, arrière-plan de cuisine entièrement flou. Très gros "
  "plan de face sur l\u2019étiquette de papier blanc collée au dos d\u2019une boîte de "
  "conserve sans marque : l\u2019étiquette remplit tout le cadre, on ne devine que les "
  "bords courbes et métalliques de la boîte à gauche et à droite. On ne voit que "
  "le HAUT du tableau de valeur nutritive, en très gros caractères noirs bien nets "
  "sur fond blanc, six lignes seulement qui occupent toute la hauteur de l\u2019image : "
  "« Valeur nutritive », « par 1 tasse (250 mL) », un trait épais, « Calories 180 », "
  "« Lipides 5 g   8 % », « Sodium 460 mg   20 % ». Le bas du tableau est coupé par "
  "le bord inférieur. Français du Québec, correctement orthographié, sans un mot "
  "d\u2019anglais. Aucun nom de marque, aucun logo, aucune personne."),
