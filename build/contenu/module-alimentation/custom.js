  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     <div class="c-hdr"><span class="tag" style="background:#0F766E">Jeu de rôle</span><span class="ctit" style="color:#0F766E">Commande à un comptoir</span></div>
  ...
  document.getElementById('exs-retiens').innerHTML = `
   <div class="card custom">
     ...
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Commander et mesurer</div>
     <textarea rows="2" placeholder="Ex. : une livre, deux cents grammes, tranché mince, du bœuf haché, une poitrine…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Garder les aliments</div>
     <textarea rows="2" placeholder="Ex. : ça se garde deux jours, emballer, congeler, le bas du réfrigérateur…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Lire une étiquette</div>
