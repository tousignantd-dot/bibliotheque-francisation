  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     <div class="c-hdr"><span class="tag" style="background:#7E3F98">Jeu de rôle</span><span class="ctit" style="color:#7E3F98">Informe-toi sur une activité</span></div>
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Demande les conditions</div><div class="jr-rappel-x">Est-ce qu'<b>il faut</b> une preuve de résidence ?</div></div>
         <div><div class="jr-rappel-l">Compare avant de choisir</div><div class="jr-rappel-x">C'est <b>la moins chère</b> des deux ?</div></div>
         <div><div class="jr-rappel-l">Fais répéter un montant</div><div class="jr-rappel-x">Quatre-vingt-cinq, <b>c'est bien ça</b> ?</div></div>
       </div>
     </div>
  ...
  document.getElementById('exs-retiens').innerHTML = `
   <div class="card custom">
     ...
     <div style="font-weight:800;color:#A5335F;font-size:13px;margin:6px 0 4px">S'inscrire</div>
     <textarea rows="2" placeholder="Ex. : une inscription, un dépliant, le tarif, une preuve de résidence, une session…"></textarea>
     <div style="font-weight:800;color:#A5335F;font-size:13px;margin:12px 0 4px">À la piscine et au gymnase</div>
     ...
     <div style="font-weight:800;color:#A5335F;font-size:13px;margin:12px 0 4px">Lire le dépliant</div>
