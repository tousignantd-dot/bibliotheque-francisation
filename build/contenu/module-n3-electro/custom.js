   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Trouve le rayon</div><div class="jr-rappel-x"><b>Où est</b> le rayon des laveuses ?</div></div>
         <div><div class="jr-rappel-l">Montre l'appareil</div><div class="jr-rappel-x"><b>Cette laveuse-là</b>, elle coûte combien ?</div></div>
         <div><div class="jr-rappel-l">Demande le format</div><div class="jr-rappel-x">Elle fait <b>combien de large</b> ?</div></div>
         <div><div class="jr-rappel-l">Conclus</div><div class="jr-rappel-x"><b>Je la prends.</b> Vous pouvez la livrer samedi ?</div></div>
       </div>
     </div>
