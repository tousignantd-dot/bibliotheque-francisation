...
LEXIQUE = [
    ...
    ("stylo",         "arrivee", "un stylo", "a pen", "una pluma", C, "PIÈGE (fr·es) : au Mexique, « una pluma » est un stylo, pas une plume."),
    ...
    ("lit-double",    "chambre", "un lit double", "a full bed", "una cama matrimonial", C, "PIÈGE (fr·en) : « a double room » est une chambre pour deux, pas forcément un lit double."),
    ...
    ("serviettes",    "chambre", "des serviettes", "towels", "toallas", C, "PIÈGE (fr·es) : « servilletas » sont des serviettes DE TABLE ; au bain, ce sont des « toallas »."),
    ...
    ("autobus",       "vacances", "l'autobus", "the bus", "el camión", C, "PIÈGE (fr·es) : au Mexique « el camión » est l'autobus, pas un camion."),
