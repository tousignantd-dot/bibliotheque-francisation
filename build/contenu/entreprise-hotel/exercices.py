...
#   PIEGES[id][interface] = (phrase dans la langue apprise, fausse lecture, explication)
PIEGES = {
    # fr·en
    "souper": {"fr": ("The restaurant serves dinner from six to ten.", "le dîner",
                      "Le soir, « dinner » est le souper ; le dîner québécois, c'est « lunch »."),
               },
    "dejeuner": {"en": ("Le déjeuner est servi de sept heures à dix heures.", "lunch",
                        "From seven to ten: in Québec, « le déjeuner » is breakfast. Lunch is « le dîner »."),
                 },
    "billet": {"fr": ("Your ticket for tonight's show is at the front desk.", "une contravention",
                      "Un billet de spectacle : ici, « ticket » n'est pas une contravention."),
               "en": ("Votre billet pour le spectacle est à la réception.", "a bill",
                      "A show ticket: « un billet » is not a bill to pay (« la facture »).")},
    "etage": {"fr": ("Your room is on the twelfth floor.", "le plancher",
                     "Une chambre au douzième : « floor », c'est ici l'étage, pas le plancher."),
              },
    "monnaie": {"fr": ("Here's your change: two dollars and fifty cents.", "un changement",
                       "Deux dollars cinquante : « change », c'est la monnaie qu'on rend."),
                "en": ("Voici votre monnaie : deux dollars cinquante.", "money",
                       "Two fifty handed back: « la monnaie » is change, not money (« l'argent »).")},
    "depot": {"en": ("Nous prenons un dépôt de cent dollars sur votre carte.", "a warehouse",
                     "A hundred dollars on your card: « un dépôt » is a deposit, not a warehouse.")},
    "location-auto": {"en": ("Pour la location d'auto, il faut un permis de conduire.", "the car's location",
                             "You need a licence for it: « la location » is a rental, not a place.")},
    # fr·es
    "stylo": {"fr": ("Firme aquí, por favor. Aquí tiene una pluma.", "une plume",
                     "Pour signer : au Mexique, « una pluma » est d'abord un stylo."),
              },
    "prenom": {"fr": ("¿Me dice su nombre? Su apellido ya lo tengo.", "le nom de famille",
                      "« Nombre », c'est le prénom ; le nom de famille, c'est « el apellido »."),
               "es": ("Votre prénom, s'il vous plaît? J'ai déjà votre nom de famille.", "el apellido",
                      "« Le prénom » es el nombre de pila; el apellido es « le nom de famille ».")},
    "serviettes": {"es": ("Je vous monte des serviettes propres pour la douche.", "servilletas",
                          "Para la regadera: « des serviettes » son toallas, no servilletas.")},
    "diner": {"fr": ("La comida se sirve de una a cuatro de la tarde.", "le souper",
                     "De une heure à quatre heures : au Mexique, « la comida » est le repas du midi."),
              "es": ("Le dîner est servi de midi à quatorze heures.", "la cena",
                     "De doce a dos: en Quebec, « le dîner » es la comida del mediodía, no la cena.")},
    "frais": {"fr": ("Hay un cargo de veinte dólares por el estacionamiento.", "un navire de charge",
                     "Vingt dollars pour le stationnement : « un cargo » est un frais."),
              "es": ("Il y a des frais de vingt dollars pour le stationnement.", "algo fresco",
                     "Veinte dólares: « des frais » es un cargo, no algo fresco.")},
    "facture": {"fr": ("Aquí tiene la cuenta de su estancia.", "le compte en banque",
                       "Pour un séjour : « la cuenta », c'est la facture de l'hôtel.")},
    "autobus": {"fr": ("El camión al centro pasa enfrente del hotel cada diez minutos.", "un camion",
                       "Toutes les dix minutes vers le centre : au Mexique, « el camión » est d'abord l'autobus.")},
    "tout-droit": {"fr": ("El museo está todo derecho, a dos cuadras.", "à droite",
                          "« Todo derecho », c'est tout droit ; à droite se dit « a la derecha »."),
                   "es": ("Le musée est tout droit, à deux coins de rue.", "a la derecha",
                          "« Tout droit » es todo derecho; a la derecha es « à droite ».")},
    # es·en
    "sortie": {"es": ("The emergency exit is at the end of the hall.", "el éxito",
                      "Al fondo del pasillo: « exit » es la salida; « éxito » en inglés es « success »."),
               },
    "embarrasse": {"es": ("I'm so embarrassed, I forgot my wallet.", "estoy embarazada",
                          "Olvidó su cartera: « embarrassed » es « me da pena ». « Embarazada » es « pregnant »."),
                   "en": ("Me da pena, olvidé mi cartera.", "it hurts me",
                          "She forgot her wallet: « me da pena » means I'm embarrassed.")},
    "dossier": {"en": ("Su confirmación está en esta carpeta.", "the carpet",
...
# ── Les nombres et les heures (révisé au tour 1, E1) ─────────────────────
# (id, {langue: phrase dite}, bonne, [(voisine, nature de l'erreur)]). La
# rétroaction se construit sur la NATURE de l'erreur (ERREURS_NOMBRES).
NOMBRES = [
    ("n1", {"fr": "Vous êtes à la chambre quatre cent douze.",
            "en": "You're in room four-twelve.",
            "es": "Está en la habitación cuatrocientos doce."},
     "412", [("421", "inv"), ("214", "inv"), ("402", "voisin")]),
    ("n2", {"fr": "La chambre douze cent huit, au douzième étage.",
     ...
     "1208", [("1280", "inv"), ("2108", "inv"), ("1218", "voisin")]),
    ("n3", {"fr": "C'est cent quatre-vingt-neuf dollars la nuit.",
     ...
     "189 $", [("198 $", "inv"), ("179 $", "voisin"), ("89 $", "cent")]),
    ...
    ("n7", {"fr": "Le déjeuner commence à sept heures et demie.",
     ...
     "7:30", [("7:15", "fraction"), ("6:30", "heure"), ("17:30", "ampm")]),
    ("n8", {"fr": "La piscine ferme à vingt-deux heures quarante-cinq.",
     ...
     "22:45", [("23:15", "fraction"), ("22:15", "fraction"), ("10:45", "ampm")]),
]
ERREURS_NOMBRES = {
    ...
    "voisin": {"fr": "Un chiffre a été mal entendu.",
               "en": "One digit was misheard.",
               "es": "Una cifra se oyó mal."},
    ...
    "cents": {"fr": "Écoutez les cents : cinquante (50) n'est pas quinze (15).",
              "en": "Listen to the cents: fifty (50) is not fifteen (15).",
              "es": "Escuche los centavos: cincuenta (50) no es quince (15)."},
    ...
    "ampm": {"fr": "Matin ou soir? « p.m. », « de la tarde », « de la noche » : c'est l'après-midi ou le soir. On note sur 24 heures.",
             "en": "Morning or evening? « p.m. », « de la tarde », « de la noche » mean afternoon or evening. Write it on the 24-hour clock.",
             "es": "¿Mañana o noche? « p.m. », « de la tarde », « de la noche »: es la tarde o la noche. Se anota en formato de 24 horas."},
    "fraction": {"fr": "Écoutez la fin : « et demie » = 30, « et quart » = 15, « moins le quart » ou « a quarter to » = 45.",
                 "en": "Listen to the end: « thirty » = 30, « quarter past » = 15, « a quarter to » = 45.",
                 "es": "Escuche el final: « y media » = 30, « y cuarto » = 15, « un cuarto para » = 45."},
}
...
REPONSES = [
    {"id": "r1", "ctx": None,
     ...
     "reps": [
         (R("Bienvenue! Pouvez-vous m'épeler votre nom de famille?", "Welcome! Could you spell your last name for me?",
            "¡Bienvenido! ¿Me puede deletrear su apellido?"), None, False),
         (R("Salut! Tu peux m'épeler ton nom de famille?", "Hey! Spell your last name for me, buddy.",
            "¡Hola! ¿Me deletreas tu apellido, porfa?"),
     ...
     "reps": [
         ...
         (R("Oui, bien sûr! Je vous donne la chambre quatre cent douze.",
          ...
          R("L'hôtel est complet : on ne promet pas une chambre qu'on n'a pas.",
            ...
            "El hotel está lleno: no se promete una habitación que no hay."), False)]},
    {"id": "r4", "ctx": None,
    ...
    {"id": "r5", "ctx": None,
     ...
     "reps": [
         (R("Désolé! Je peux la voir? Je vais la réencoder tout de suite.",
            "I'm sorry! May I see it? I'll re-encode it right away.",
    ...
    {"id": "r6", "ctx": R("Au téléphone.", "On the phone.", "Por teléfono."),
     ...
     "reps": [
         (R("Bien sûr. Pouvez-vous me donner votre numéro de confirmation?",
    ...
    {"id": "r8", "ctx": None,
     ...
     "reps": [
         (R("C'est la taxe sur l'hébergement : elle s'applique à chaque nuit.",
            ...
            "Es el impuesto al hospedaje. Se cobra por cada noche."), None, False),
         ...
         (R("C'est une taxe, mais je peux l'enlever de votre facture.",
          ...
          R("Une taxe ne s'enlève pas : c'est la loi, ni vous ni le gérant ne l'effacez.",
            ...
            "Un impuesto no se quita: es la ley, ni usted ni el gerente pueden quitarlo."), False)]},
    {"id": "r9", "ctx": R("Le stationnement coûte 20 $ par nuit.", "Parking is $20 a night.",
     ...
     "reps": [
         (R("Il coûte vingt dollars par nuit, et vous pouvez entrer et sortir.",
            "It's twenty dollars a night, and you can come and go.",
    ...
    {"id": "r10", "ctx": R("Départ tardif : 30 $ jusqu'à 14 h ; plus tard, c'est le gérant qui décide.",
     ...
     "reps": [
         (R("Jusqu'à 14 h, c'est trente dollars. Pour 16 h, je vais demander au gérant.",
    ...
    {"id": "r11", "ctx": None,
     ...
     "reps": [
         (R("Je comprends. Je ne peux pas l'enlever moi-même; je transmets au gérant.",
         ...
         (R("Les règles sont les règles. Il fallait annuler plus tôt que ça.",
    ...
    {"id": "r12", "ctx": None,
     ...
     "reps": [
         (R("Félicitations! Je vais demander au gérant si c'est possible.",
            ...
            "¡Felicidades! Le pregunto al gerente si se puede."), None, False),
