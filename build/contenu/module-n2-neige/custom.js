   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Demande le temps</div><div class="jr-rappel-x"><b>Quel temps fait-il</b> aujourd'hui ? · <b>Est-ce qu'</b>il neige ?</div></div>
         <div><div class="jr-rappel-l">Demande la température</div><div class="jr-rappel-x">Il fait <b>combien</b> de degrés ?</div></div>
         <div><div class="jr-rappel-l">Vérifie le nombre</div><div class="jr-rappel-x"><b>Moins douze</b> ? D'accord, merci.</div></div>
         <div><div class="jr-rappel-l">Dis ce que tu mets</div><div class="jr-rappel-x"><b>Je mets</b> ma tuque et mes mitaines.</div></div>
       </div>
     </div>
