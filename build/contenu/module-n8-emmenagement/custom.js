  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-sub">Les dix sujets à couvrir</div>
     <div class="jr-sujets">
     ...
     <div class="jr-gram">
       ...
       Découpez la conversation :
       <span class='savoir-ex'><b>Reprenons</b> les trois points l'un après l'autre.</span>
       Concédez, puis retournez :
       <span class='savoir-ex'><b>Certes</b> la clause existe. <b>Or</b> elle parle du transport, et le meuble a été fendu dans l'escalier.</span>
       Faites préciser :
       <span class='savoir-ex'><b>Sur quelle clause</b> vous appuyez-vous ? Pouvez-vous me la relire ? Je veux les mots exacts.</span>
       Dites ce qui aurait pu être évité :
       <span class='savoir-ex'><b>Si on m'avait offert</b> une déclaration de valeur, j'en <b>aurais fait</b> une.</span>
       Mettez en relief ce qui compte :
       <span class='savoir-ex'><b>Ce que je conteste, c'est</b> le refus complet, <b>pas</b> votre évaluation.</span>
       Résumez pour vérifier :
       <span class='savoir-ex'><b>Je résume, pour être certaine :</b> vous soumettez le troisième point au réviseur, et j'envoie les quatre pièces aujourd'hui.</span>
     </div>
