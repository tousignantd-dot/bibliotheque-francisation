const PLUS = {
  ...
  prReg: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Le familier — entre gens qui se connaissent",
       ...
       mots:[['Ce qu\'on entend','« C\'était plate. » · « Y a des bouts où j\'ai décroché. » · « Ça m\'a fait capoter. »'],['Les signes','le « ne » disparaît, « il y a » devient « y a », les mots se coupent'],['Où','corridor, pause, souper de famille']],
      ...
      {t:'ana', h:"Le standard — avec presque tout le monde",
       ...
       mots:[['Ce qu\'on entend','« Je n\'ai pas trouvé le temps long. » · « J\'ai perdu le fil deux ou trois fois. » · « La salle a beaucoup ri. »'],['Les signes','phrases complètes, « ne » présent, vocabulaire courant'],['Où','réunion, comptoir, courriel de travail']],
      ...
      {t:'labo', h:"Le même avis, dans les trois registres",
       ...
       axes:[
         {id:'i', lbl:'Quelle idée ?', opts:[['a','le film est lent'],['b','la salle a ri'],['c','la fin m\'a touchée']]},
  ...
  prAvis: {
    ...
    blocs:[
      ...
      {t:'labo', h:"Transformer un goût en argument",
       ...
       axes:[
         {id:'o', lbl:'Quelle œuvre ?', opts:[['a','le sketch'],['b','la chanson'],['c','le film']]},
         {id:'n', lbl:'Quel niveau ?', opts:[['1','un goût'],['2','un argument']]}],
       out:{
      ...
      {t:'piege', h:"Trois pièges",
       rows:[
         ...
         ["présenter son avis comme un fait","l'annoncer comme un avis",
  ...
  t1trans: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Le repérage 1 — cherchez ce que personne ne peut croire",
       p:"Une phrase que nul ne dirait sérieusement est presque toujours l'endroit du procédé.",
       mots:[['Dans le sketch','« J\'adore ça, attendre. » · « Elle est heureuse, dans le système. »'],['La question à poser','qui pourrait dire cela sérieusement ?'],['Ce qu\'on trouve','l\'ironie, l\'exagération, la personnification']],
  ...
  t1proc: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Le burlesque et l'absurde",
       ...
       mots:[['Burlesque','la chute, l\'objet qui casse, le geste maladroit, la poursuite'],['Absurde','« le système est au deuxième, derrière la porte barrée »'],['La différence','l\'un se voit, l\'autre se pense']],
      ...
      {t:'labo', h:"Le procédé et sa phrase",
       ...
       axes:[
         {id:'p', lbl:'Quel procédé ?', opts:[['a','ironie'],['b','caricature'],['c','absurde'],['d','autodérision']]},
  ...
  t1inc: {
    ...
    blocs:[
      ...
      {t:'labo', h:"Transformer une phrase en incise",
       ...
       axes:[
         {id:'s', lbl:'Quel sujet ?', opts:[['a','elle'],['b','il'],['c','le gérant']]},
         {id:'v', lbl:'Quel verbe ?', opts:[['1','dire'],['2','répondre'],['3','ajouter']]}],
       out:{
    ...
    blocs:[
      ...
      {t:'piege', h:"Trois pièges",
       rows:[
         ...
         ["oublier le « que »","le mettre à chaque fois",
  ...
  t1emph: {
    ...
    blocs:[
      ...
      {t:'ana', h:"C'est… qui — pour mettre le sujet en avant",
       p:"On encadre le sujet, et le reste de la phrase suit derrière « qui ».",
       mots:[['La phrase ordinaire','Le ton fait rire.'],['La phrase clivée','<b>C\'est le ton qui</b> fait rire.'],['L\'accord','le verbe suit ce qu\'on met en avant : c\'est moi qui <b>ai</b>']],
      ...
      {t:'ana', h:"C'est… que — pour tout le reste",
       ...
       mots:[['Un complément','<b>C\'est ce passage que</b> j\'ai préféré.'],['Un moment','<b>C\'est à la fin qu\'</b>il exagère.'],['Un lieu','<b>C\'est dans un sous-sol qu\'</b>elle chante.']],
      ...
      {t:'labo', h:"La même idée, trois mises en relief",
       ...
       axes:[
         {id:'i', lbl:'Quelle idée ?', opts:[['a','le ton fait rire'],['b','j\'ai aimé la quatrième nuit'],['c','Gaétan a le meilleur argument']]},
         {id:'f', lbl:'Quelle forme ?', opts:[['1','phrase ordinaire'],['2','clivée'],['3','annoncée']]}],
       out:{
  ...
  t2paroles: {
    ...
    blocs:[
      {t:'texte', h:"Deux choses en même temps",
      ...
      {t:'ana', h:"Les mots qui reviennent",
       ...
       mots:[['Le verbe','<b>monter</b> — trois fois dans le refrain seul'],['Le nombre','<b>neuf</b> — neuf ans, neuf fois'],['Ce que ça dit','un mouvement qui recommence et n\'aboutit pas']],
  ...
  t2repr: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Le « ils » qui ne reprend rien",
       ...
       mots:[['Dans la chanson','<b>Ils</b> ont refait la rampe, <b>ils</b> n\'ont rien refait d\'autre.'],['Ailleurs','<b>Ils</b> ont encore augmenté le loyer. · <b>Ils</b> annoncent de la neige.'],['Ce que ça fait','ça laisse chacun mettre le nom qu\'il veut']],
      ...
      {t:'labo', h:"Quelle reprise employer ?",
       ...
       axes:[
         {id:'p', lbl:'Quelle phrase ?', opts:[['a','J\'ai vu le film jeudi.'],['b','Elle parle de son escalier.'],['c','J\'avais dit l\'an prochain.']]},
         {id:'r', lbl:'Quelle reprise ?', opts:[['1','un pronom'],['2','un autre mot']]}],
       out:{
  ...
  t2int: {
    ...
    blocs:[
      ...
      {t:'ana', h:"si / tellement + adjectif ou adverbe + que",
       ...
       mots:[['Avec un adjectif','Le vent est <b>tellement</b> froid <b>qu\'</b>elle oublie de compter.'],['Avec un adverbe','Elle chante <b>si</b> fort <b>qu\'</b>on l\'entend dehors.'],['Le mode','indicatif — ça se produit']],
      ...
      {t:'ana', h:"Un seul sujet : pour + infinitif",
       p:"Quand c'est la même personne des deux côtés, on allège.",
       mots:[['Deux sujets','Elle est trop fatiguée <b>pour que</b> nous <b>sortions</b>.'],['Un seul sujet','Elle est trop fatiguée <b>pour sortir</b>.'],['Le test','demandez qui fait quoi de chaque côté']],
      ...
      {t:'labo', h:"Le degré et sa conséquence",
       ...
       axes:[
         {id:'i', lbl:'Quelle idée ?', opts:[['a','le film est lent'],['b','la salle est petite'],['c','le billet coûte cher']]},
         {id:'t', lbl:'Quelle tournure ?', opts:[['1','tellement… que'],['2','trop / assez… pour que']]}],
       out:{
  ...
  t2gen: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Le sens spécifique — et ce qui l'accroche au réel",
       p:"Un complément, une relative, un démonstratif : quelque chose montre du doigt.",
       mots:[['Un complément','La musique <b>de ce film</b> intervient onze fois.'],['Une relative','La chanson <b>qu\'elle a chantée en rappel</b> n\'est pas sur son disque.'],['Un démonstratif','<b>Ce</b> film-<b>là</b> m\'a endormie.']],
      ...
      {t:'ana', h:"« Il y a… qui » — le spécifique du français parlé",
       ...
       mots:[['Ce qu\'on dit','<b>Il y a un</b> gars <b>qui</b> a ri tout seul.'],['Ce qu\'on ne dit pas','Un gars a ri tout seul.'],['Où','partout, dans toute conversation en français du Québec']],
  ...
  t3crit: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Les faits — quelqu'un d'autre peut aller compter",
       ...
       mots:[['Dans la critique','« Le film dure une heure cinquante. » · « Elle intervient onze fois. »'],['Le test','deux personnes qui vérifient trouvent la même chose'],['Ce qu\'on en fait','on s\'en sert pour appuyer, ou pour contredire']],
      ...
      {t:'ana', h:"La nuance — le mot qui annonce le virage",
       ...
       mots:[['Dans la critique','« <b>Bien que</b> le rythme demeure lent, la deuxième heure tient sans effort. »'],['Ce que ça montre','le critique a vu l\'objection et il y répond d\'avance'],['Ce que ça vaut','beaucoup : un texte sans nuance est une publicité']],
  ...
  t3conc: {
    ...
    blocs:[
      ...
      {t:'ana', h:"malgré + nom",
       ...
       mots:[['La forme','<b>Malgré</b> sa <b>lenteur</b>, le film tient.'],['La transformation','lent devient <b>la lenteur</b> · long devient <b>la longueur</b> · cher devient <b>le prix</b>'],['La faute','« malgré qu\'il soit lent » est à éviter à l\'écrit']],
      ...
      {t:'ana', h:"Où placer la concession",
       ...
       mots:[['Bon ordre','Bien que ce soit cher, <b>j\'y vais</b>.'],['Mauvais ordre','J\'y vais, <b>bien que ce soit cher</b>.'],['Ce que ça change','la première finit sur votre décision, la seconde sur l\'obstacle']],
      ...
      {t:'labo', h:"Trois marqueurs, une seule idée",
       ...
       axes:[
         ...
         {id:'m', lbl:'Quel marqueur ?', opts:[['1','bien que'],['2','même si'],['3','malgré']]}],
       out:{
      ...
      {t:'check', h:"Est-ce que c'est clair maintenant ?",
       ...
       qs:[
         ...
         {q:"La concession se place…", opts:["avant sa position","après sa position"], ok:0,
  ...
  t3si: {
    ...
    blocs:[
      ...
      {t:'ana', h:"La règle en une ligne",
       p:"Si + imparfait, puis conditionnel présent. Et jamais l'inverse.",
       mots:[['La forme','<b>Si</b> le budget <b>était</b> plus grand, je <b>proposerais</b> l\'humour.'],['Ce que ça veut dire','le budget n\'est pas plus grand'],['Ce qui est interdit','« si j\'aurais » n\'existe pas']],
      ...
      {t:'ana', h:"Comment se fabrique le conditionnel",
       ...
       mots:[['Régulier','je propos<b>erais</b> · tu chant<b>erais</b> · elle finir<b>ait</b>'],['Les six terminaisons','-rais, -rais, -rait, -rions, -riez, -raient'],['Le signe','le <b>r</b>, qui le distingue de l\'imparfait']],
      ...
      {t:'labo', h:"L'hypothèse, ou la politesse ?",
       ...
       axes:[
         {id:'v', lbl:'Quel verbe ?', opts:[['a','pouvoir'],['b','vouloir'],['c','aller']]},
         {id:'e', lbl:'Quel emploi ?', opts:[['1','hypothèse'],['2','politesse']]}],
       out:{
  ...
  t3conn: {
    ...
    blocs:[
      ...
      {t:'ana', h:"Redire plus simplement",
      ...
      {t:'piege', h:"Trois pièges",
       rows:[
         ...
         ["en mettre partout","un par mouvement",
  ...
  t3plan: {
    ...
    blocs:[
      ...
      {t:'ana', h:"2. L'avis, annoncé comme un avis",
       ...
       mots:[['Les verbes','je propose · j\'ai trouvé · il m\'a semblé · j\'ai été touchée'],['Ce qu\'on évite','« ce film est ennuyant », qui se présente comme un fait'],['Pourquoi','l\'autre peut ne pas être d\'accord sans vous contredire']],
      ...
      {t:'ana', h:"4. La concession — avant votre position",
       ...
       mots:[['La forme parlée','« C\'est vrai que… » · « Je te l\'accorde… »'],['La forme écrite','« Bien que… » · « Malgré… »'],['La place','avant ce que vous voulez faire retenir']],
      ...
      {t:'labo', h:"Les quatre morceaux, sur les trois œuvres",
       ...
       axes:[
         {id:'o', lbl:'Quelle œuvre ?', opts:[['a','le film'],['b','le sketch'],['c','la chanson']]},
         {id:'m', lbl:'Quel morceau ?', opts:[['1','le résumé'],['2','le moment précis'],['3','la concession']]}],
       out:{
      ...
      {t:'piege', h:"Trois pièges",
       rows:[
         ["raconter toute l'histoire","deux ou trois phrases, sans la fin",
      ...
      {t:'check', h:"Est-ce que c'est clair maintenant ?",
       ...
       qs:[
         ...
         {q:"La concession se place…", opts:["avant sa position","à la toute fin"], ok:0,
          fb:"On finit sur ce qu'on veut faire retenir."},
