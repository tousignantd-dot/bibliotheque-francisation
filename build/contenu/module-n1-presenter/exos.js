const EXOS = [
 // ── JE DÉCOUVRE ─────────────────────────────────────────────
  ...
  {sec:'prep', id:'prAlpha', type:'vf', num:'Exercice 2', tit:"Quelle lettre entends-tu ?", color:'#1D6B8F', accent:'#1D6B8F', cards:true, listen:true,
   sub:"Écoute bien. Ces lettres se ressemblent.", tiles:['LA PREMIÈRE','LA DEUXIÈME'],
   rows:[
    {id:'ala', txt:"E", ok:'LA PREMIÈRE'},
    {id:'alb', txt:"I", ok:'LA DEUXIÈME'},
    {id:'alc', txt:"G", ok:'LA PREMIÈRE'},
    {id:'ald', txt:"J", ok:'LA DEUXIÈME'},
    {id:'ale', txt:"M", ok:'LA PREMIÈRE'},
    {id:'alf', txt:"N", ok:'LA DEUXIÈME'},
   ]},
