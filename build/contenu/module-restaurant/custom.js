   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Commande poliment</div><div class="jr-rappel-x">Je <b>voudrais</b> la table d'hôte, avec la soupe.</div></div>
         <div><div class="jr-rappel-l">Demande une précision</div><div class="jr-rappel-x">Qu'est-ce qu'il y a <b>dans</b> le plat du jour ?</div></div>
         <div><div class="jr-rappel-l">Demande quelque chose pendant le repas</div><div class="jr-rappel-x"><b>Est-ce que je pourrais avoir</b> un peu de sel ?</div></div>
         <div><div class="jr-rappel-l">Signale ce qui ne va pas</div><div class="jr-rappel-x"><b>Est-ce que ce serait possible de</b> le réchauffer ?</div></div>
       </div>
     </div>
