  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     <div class="c-hdr"><span class="tag" style="background:#0F766E">Jeu de rôle</span><span class="ctit" style="color:#0F766E">Commande un repas</span></div>
  ...
  document.getElementById('exs-retiens').innerHTML = `
   <div class="card custom">
     ...
     <div style="font-weight:800;color:#166534;font-size:13px;margin:6px 0 4px">Le menu</div>
     <textarea rows="2" placeholder="Ex. : la carte, le menu du jour, la table d'hôte, à la carte, une entrée, le plat du jour…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Commander poliment</div>
     <textarea rows="2" placeholder="Ex. : je voudrais, je prendrais, pourriez-vous, est-ce que je pourrais avoir…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">Pendant le repas</div>
     <textarea rows="2" placeholder="Ex. : une carafe, l'eau du robinet, un accompagnement, excusez-moi, le réchauffer…"></textarea>
     <div style="font-weight:800;color:#166534;font-size:13px;margin:12px 0 4px">L'addition</div>
