   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Demandez au conditionnel</div><div class="jr-rappel-x"><b>Accepteriez-vous</b> de mettre un tapis de caoutchouc ? · <b>Pourriez-vous</b> regarder si l'appareil rentre dans le couloir ?</div></div>
         <div><div class="jr-rappel-l">Concédez d'abord, demandez ensuite</div><div class="jr-rappel-x"><b>Même si</b> votre horaire est difficile, le mien l'est aussi. · <b>Bien que</b> je comprenne, je ne dors plus.</div></div>
         <div><div class="jr-rappel-l">Dites la conséquence, pas l'émotion</div><div class="jr-rappel-x">Cela m'<b>empêche de</b> dormir plus de quatre heures. · Cela m'<b>oblige à</b> me lever à cinq heures trente.</div></div>
         <div><div class="jr-rappel-l">Dites jusqu'où ça va</div><div class="jr-rappel-x">C'est <b>tellement</b> régulier <b>que</b> je me réveille avant. · C'est <b>assez</b> fort <b>pour</b> faire bouger le luminaire.</div></div>
         <div><div class="jr-rappel-l">Restreignez pour désamorcer</div><div class="jr-rappel-x">Je <b>ne</b> me plains <b>que</b> du matin. · Je <b>ne</b> demande <b>qu'</b>une heure de sommeil de plus.</div></div>
       </div>
     </div>
