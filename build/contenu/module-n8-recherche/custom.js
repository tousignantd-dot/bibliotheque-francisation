  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-bande">
       ...
       <button class="btn btn-pri" id="jrStart" type="button" onclick="jrDemarrer()">Commencer l'entrevue</button>
     </div>
     <div class="jr-rappel">
       <div class="jr-rappel-t">Réutilisez ce que vous venez d'apprendre</div>
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Concédez, puis avancez</div><div class="jr-rappel-x"><b>Certes</b> cette expérience a été acquise ailleurs, <b>mais</b> elle porte sur vingt-deux personnes.</div></div>
         <div><div class="jr-rappel-l">Dites ce que vous feriez autrement</div><div class="jr-rappel-x"><b>Si j'avais eu</b> les données de production, j'<b>aurais arrêté</b> la ligne plus tôt.</div></div>
         <div><div class="jr-rappel-l">Mettez en avant ce qui compte</div><div class="jr-rappel-x"><b>Ce que j'apporte, c'est</b> seize ans d'usine, dont onze en supervision.</div></div>
         <div><div class="jr-rappel-l">Demandez poliment et fermement</div><div class="jr-rappel-x">J'<b>aimerais</b> qu'on <b>regarde</b> le quatrième échelon, et je vais vous dire pourquoi.</div></div>
         <div><div class="jr-rappel-l">Refermez une question interdite</div><div class="jr-rappel-x">Je vous réponds sur ce qui vous intéresse : je suis disponible cinq soirs sur cinq. <b>Pour le reste, je préfère ne pas répondre.</b></div></div>
       </div>
     </div>
