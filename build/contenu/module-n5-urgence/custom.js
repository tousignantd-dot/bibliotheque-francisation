  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-gram">
       ...
       Donnez l'endroit, puis le détail :
       <span class='savoir-ex'>5412, rue des Ormeaux, appartement 2, <b>en bas de</b> l'escalier intérieur.</span>
       Dites ce qui se passe en une phrase :
       <span class='savoir-ex'>Ma mère <b>est tombée</b> dans l'escalier et elle ne peut pas se relever.</span>
       Répondez court :
       <span class='savoir-ex'>Oui, elle me répond. · Oui, elle respire. · <b>Je ne sais pas</b>, je ne l'ai pas vue tomber.</span>
       Comprenez les ordres à l'impératif :
       <span class='savoir-ex'><b>Restez</b> près d'elle. · <b>Ne la déplacez pas.</b> · <b>Couvrez-la.</b> · <b>Ne lui donnez rien</b> à boire.</span>
       Dites ce que vous faites :
       <span class='savoir-ex'>Je <b>la</b> couvre. Je <b>lui</b> parle. Je descends déverrouiller la porte.</span>
       Demandez ce que vous devez savoir :
       <span class='savoir-ex'>Est-ce que je <b>peux</b> lui donner ses médicaments ? Ils arrivent dans combien de temps ?</span>
     </div>
