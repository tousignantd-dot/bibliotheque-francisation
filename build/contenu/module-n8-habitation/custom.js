  ...
  document.getElementById('exs-appli').innerHTML += `
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-gram">
       ...
       <span class='savoir-ex'><b>Certes</b>, ce n'est pas vous qui avez rendu la décision ; <b>il n'en reste pas moins que</b> c'est à vous que je peux parler.</span>
       Déroulez l'hypothèse :
       <span class='savoir-ex'><b>Si</b> le drain <b>avait été</b> bouché depuis des années, l'eau <b>serait remontée</b> bien avant.</span>
       Mettez en avant ce que vous contestez :
       <span class='savoir-ex'><b>Ce que je conteste, c'est</b> le motif, non le montant.</span>
       Demandez au subjonctif :
       <span class='savoir-ex'>Je demande <b>que</b> le dossier <b>soit</b> rouvert et <b>qu'</b>une réponse motivée me <b>parvienne</b> par écrit.</span>
       Fixez l'ordre des choses :
       <span class='savoir-ex'><b>Quand</b> vous <b>aurez reçu</b> ma lettre, le délai de soixante jours commencera à courir.</span>
     </div>
