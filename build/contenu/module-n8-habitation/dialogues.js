const DIALOGUES = {
  ...
  t3: {
    ...
    lines: [
      ...
      ["FABIEN","Premier temps. Beaucoup de gens croient qu'une plainte, c'est un appel où l'on exprime son mécontentement. Ce n'est pas cela. Une plainte, au sens du règlement, c'est un reproche écrit adressé à l'entreprise, dans lequel vous demandez une mesure correctrice. Trois éléments : c'est écrit, ça vise l'entreprise, et ça demande quelque chose de précis."],
      ["FABIEN","Ce qui suit est important. Tant que vous n'avez que téléphoné, il ne s'est rien passé au sens de la loi. Vos délais ne courent pas, votre dossier n'est pas ouvert, et personne n'est tenu de vous répondre dans un temps donné. C'est l'écrit qui déclenche tout."],
