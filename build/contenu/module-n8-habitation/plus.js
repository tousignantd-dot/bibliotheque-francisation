  ...
  prInto: {
    ...
    blocs:[
      {t:'texte', h:"Le seul savoir de phonétique du niveau 8",
       p:"Le programme du niveau 8 ne demande plus qu'une chose à l'oreille et à la voix : produire l'<b>intonation expressive</b>. Pas un son nouveau, pas une liaison de plus — une mélodie. À ce stade, vous prononcez déjà assez bien pour être compris ; ce qui vous reste à gagner, c'est ce que la voix ajoute par-dessus les mots. Une même phrase de six mots peut dire la surprise, l'incompréhension ou la détermination, et c'est souvent la seule chose que votre interlocuteur retiendra.",
       note:"Une intonation plate se lit comme de l'indifférence, alors qu'elle n'est le plus souvent que de la prudence."},

      {t:'texte', h:"Pourquoi ça compte quand on conteste quelque chose",
       p:"Vous téléphonez à quelqu'un qui reçoit trente appels par jour et qui décidera, en deux minutes, si votre dossier mérite une note au registre. Cette personne ne se souviendra ni de vos dates ni de vos montants : elle se souviendra d'une impression. Or l'impression se fabrique presque entièrement avec la mélodie. Dire « je conteste cette décision » d'une voix hésitante annonce déjà que vous n'irez pas jusqu'au bout, et l'autre l'entend avant d'avoir compris la phrase.",
       note:"Il ne s'agit pas d'élever la voix. Une contestation efficace se dit calmement — mais avec une mélodie qui descend, jamais qui monte."},
      ...
      {t:'ana', h:"La surprise — la voix monte d'un coup, à la fin",
       ...
       mots:[['On dit',"Vous me dites que le drain n'a pas été entretenu ?"],['La mélodie','plate, puis très haute à la fin',true],['Le repère','on répète le mot qui surprend']],
      ...
      {t:'ana', h:"L'incompréhension — la voix freine et hésite au milieu",
       ...
       mots:[['On dit',"Excusez-moi, le mot « exclusion »… vous l'employez comment ?"],['La mélodie','un creux et un silence avant le mot',true],['Le repère','on isole le mot avec la voix']],
      ...
      {t:'ana', h:"La volonté — la voix descend, et chaque mot pèse",
       p:"À l'inverse de la surprise : la mélodie descend, le débit ralentit, les syllabes se détachent. C'est la voix de l'engagement, et c'est celle qui convient à une contestation.",
       mots:[['On dit','Je veux une réponse écrite, et je l\'aurai.'],['La mélodie','descendante, appuyée sur « veux »',true],['Le repère','on ne sourit pas en le disant']],
       say:"Je veux une réponse écrite, et je l'aurai.",
       note:"Une phrase de volonté dite avec une mélodie montante devient une demande de permission. C'est exactement l'inverse de ce qu'on voulait."},

      {t:'ana', h:"La déception — la voix tombe dès le début",
       p:"La quatrième, la plus utile à reconnaître chez l'autre : la mélodie descend dès la première syllabe et ne remonte jamais. Le débit est régulier, presque lent.",
       mots:[['On dit',"Ah. Je pensais que la facture était au dossier."],['La mélodie','descendante dès le premier mot',true],['Le repère','un « ah » ou un « bon » en tête']],
      ...
      {t:'labo', h:"Écoutez les quatre intentions",
       ...
       out:{
         a1:{w:["Quatre pages ?"], say:"Quatre pages ?", n:'la voix monte d\'un coup sur « pages »'},
         a2:{w:["Comment ça, la facture n'est pas au dossier ?"], say:"Comment ça, la facture n'est pas au dossier ?", n:'« comment ça » annonce la surprise'},
         b1:{w:["Je perds le fil."], say:"Je perds le fil.", n:'débit qui freine, mélodie creusée'},
         b2:{w:["Vous avez bien dit soixante jours ?"], say:"Vous avez bien dit soixante jours ?", n:'on isole le chiffre dont on n\'est pas sûr'},
         c1:{w:["Je le fais rouvrir, ce dossier-là."], say:"Je le fais rouvrir, ce dossier-là.", n:'mélodie descendante, syllabes détachées'},
         ...
         d2:{w:["Je pensais que c'était réglé."], say:"Je pensais que c'était réglé.", n:'descendante du début à la fin'},
       },
      ...
      {t:'ex', h:"La même idée, trois intentions",
       ...
       rows:[
         ["La facture n'est pas au dossier ?","surprise — la voix monte sur « dossier »"],
         ["La facture n'est pas au dossier.","constat — la voix reste plate"],
         ["La facture n'est pas au dossier…","incompréhension — la voix freine et laisse ouvert"],
         ["Je veux une réponse écrite.","volonté — la voix descend, les mots pèsent"],
         ["Je veux une réponse écrite ?","doute — la même phrase se retourne contre vous"],
         ["Bon. Je veux une réponse écrite.","résignation — le « bon » tombe avant le reste"],
       ]},

      {t:'piege', h:"Trois pièges de l'intonation, au téléphone",
       rows:[
         ["monter la voix à chaque phrase","descendre quand on affirme",
          "Une mélodie qui monte partout transforme chaque affirmation en question, et chaque demande en demande d'autorisation. C'est le défaut le plus fréquent, et il vient de la politesse mal placée."],
         ["parler d'une voix parfaitement égale","varier au moins sur les trois phrases importantes",
          "Une voix plate se lit comme de l'indifférence, jamais comme du calme. Trois phrases sur dix minutes suffisent : l'annonce, la demande, le délai."],
         ["baisser la voix au moment de demander","garder la même mélodie qu'aux autres phrases",
          "Beaucoup de gens s'excusent avec la voix au moment de demander quelque chose. La demande devient inaudible, et l'autre croit qu'elle est négociable à zéro."],
       ]},
      ...
      {t:'revoir', h:"À retenir",
       p:"Quatre mélodies : la <b>surprise</b> monte d'un coup à la fin ; l'<b>incompréhension</b> freine et laisse un silence avant le mot en cause ; la <b>volonté</b> descend et appuie ; la <b>déception</b> tombe dès la première syllabe. Pour un appel de contestation, travaillez surtout la troisième."},
    ]
  },
