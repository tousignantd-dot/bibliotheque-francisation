   ...
   <div class="card custom" id="jeu-de-role">
     ...
     <div class="jr-rappel">
       ...
       <div class="jr-rappel-g">
         <div><div class="jr-rappel-l">Ne répète pas le mot, reprends-le</div><div class="jr-rappel-x">La fissure ? Je ne veux pas qu'on <b>la</b> répare avant d'avoir réglé la gouttière.</div></div>
         <div><div class="jr-rappel-l">Dis qui fait quoi</div><div class="jr-rappel-x">Vous <b>faites injecter</b> la fissure <b>par</b> un spécialiste, c'est bien ça ?</div></div>
         <div><div class="jr-rappel-l">Demande précisément</div><div class="jr-rappel-x"><b>Quel</b> délai en jours ouvrables entre l'injection et le gypse ?</div></div>
         <div><div class="jr-rappel-l">Pose une condition</div><div class="jr-rappel-x"><b>Si</b> le permis <b>sort</b> dans dix jours, est-ce que ce sera prêt le 12 ?</div></div>
         <div><div class="jr-rappel-l">Demande que ce soit écrit</div><div class="jr-rappel-x">J'aimerais <b>que</b> vous m'<b>écriviez</b> ça dans la soumission.</div></div>
       </div>
     </div>
